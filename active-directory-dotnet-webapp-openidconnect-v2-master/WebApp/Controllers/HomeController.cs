            ...
            if (cca.Users.Count() > 0)
            {
                ...
                catch (MsalUiRequiredException)
                {
                    ...
                    {// when failing, manufacture the URL and assign it
                        string authReqUrl = await Utils.OAuth2RequestManager.GenerateAuthorizationRequestUrl(scopes, cca, HttpContext, Url);
...
";
            ...
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, "https://graph.microsoft.com/v2.0/me/microsoft.graph.sendMail");
